 ...
 */
struct handler_threads_pool *init_handler_threads_pool(pthread_mutex_t *p_mutex, pthread_cond_t *p_cond_var, struct requests_queue *requests) {
    struct handler_threads_pool *pool = (struct handler_threads_pool *)malloc(sizeof(struct handler_threads_pool));
...
void add_handler_thread(struct handler_threads_pool *pool) {
    ...
    /* create the new thread's structure and initialize it for data*/
    struct handler_thread *a_thread = (struct handler_thread *)malloc(sizeof(struct handler_thread));
    ...
    struct handler_thread_params *params = (struct handler_thread_params *)malloc(sizeof(struct handler_thread_params));
...
void delete_handler_thread(struct handler_threads_pool *pool) {
    ...
    struct handler_thread *a_thread = remove_first_handler_thread(pool);
