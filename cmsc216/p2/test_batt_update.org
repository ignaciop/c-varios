...
* set_batt_from_ports() 7400 Sensor
...
* set_batt_from_ports() mixed STATUS
...
* set_display_from_batt() Mid Range P
...
* set_display_from_batt() Full Battery
** set_display_from_batt() 4.22 V
#+TESTY: program='./test_batt_update "set_display_from_batt() 4.22 V"'
#+BEGIN_SRC sh
{
    // Show 4.22 Volts
    BATT_VOLTAGE_PORT = -1;
...
* set_display_from_batt() more levels
