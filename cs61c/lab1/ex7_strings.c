...
int main(void) {
    ...
    char *hello_str = (char *)malloc(5 + 1);

    if (hello_str == NULL) {
        perror("Cannot allocate memory for hello_str array.");
    ...
    *(hello_str + 5) = '\0';
    ...
    char *world_str = (char *)malloc(5 + 1);

    if (world_str == NULL) {
        perror("Cannot allocate memory for world_str array.");
    ...
    char *hello_world_str = (char *)malloc(11 + 1);

    if (hello_world_str == NULL) {
        perror("Cannot allocate memory for hello_world_str array.");
